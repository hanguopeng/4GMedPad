...
var requestUrl = config.boneCriticallyIllQuery+"?registerNumber="+registerNumber;
var bloodGlucose = function(patientId){
    common.get({
        ...
        data:JSON.stringify({
          patientId: person.id,
          page: page,
          templateList:[{"templateCode":"gkwzhzhljld","templateVersion":1}]
        }),
...
var dealItemKeyValue = function(content){
   ...
   obj["chuliangml"] = content.chuliangml
    ...
    obj["daoguanhuli"] = content.daoguanhuli
    obj["yinshi"] = content.yinshi
    obj["jiankangzhidao"] = content.jiankangzhidao
